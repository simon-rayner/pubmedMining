...
# see here for more info https://biopython-tutorial.readthedocs.io/en/latest/notebooks/09%20-%20Accessing%20NCBIs%20Entrez%20databases.html
...
def parseDiseaseList(diseaseList, outputFolder, fStats):
    for diseaseString in diseaseList:
        ...
        results = search(diseaseString + "[TIAB]")
